       ...
       <div className="flex flex-row justify-center">
        <div className="flex flex-col justify-center min-h-screen">
          <div className="bg-white w-96 py-4 rounded-md shadow-md ">
              ...
              <div onClick={handleNavigateToOnBoarding} className="flex flex-row justify-center text-sm font-medium text-black hover:text-gray-500">New to the Platform?</div>
              <div className="px-8">
